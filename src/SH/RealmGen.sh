...
UOCNVRT_PATH="/home/dmr/shard/uoconvert"
#----------
BUILD_ALL=0
...
COPY_CLIENT_FILES()
	...
	cp ${UOPATH}/multi*.* /home/ancaria/MUL/
	cp ${UOPATH}/map*.* /home/ancaria/MUL/
	cp ${UOPATH}/staidx*.* /home/ancaria/MUL/
	cp ${UOPATH}/statics*.* /home/ancaria/MUL/
	cp ${UOPATH}/tiledata.mul /home/ancaria/MUL/
	RETURN_TO_MENU
	}
